...
class GetCategoriesPageUseCase(private val repository: CategoryRepository) { operator fun invoke(page: Int, perPage: Int, search: String) = repository.listCategoriesAdminPage(page, perPage, search) }
