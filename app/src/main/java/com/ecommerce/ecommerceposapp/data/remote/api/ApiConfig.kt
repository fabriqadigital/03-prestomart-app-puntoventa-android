...
object ApiConfig {
    ...
    const val CLIENT_LIST = "$POS_PREFIX/usuarios/listar"
    const val CLIENT_CREATE = "$POS_PREFIX/usuarios/crear"
    const val CLIENT_UPDATE = "$POS_PREFIX/usuarios/actualizar"
    const val CLIENT_DELETE = "$POS_PREFIX/usuarios/eliminar"
