...
class SunatService
{
    ...
    // ======================== GUIA REMISION ========================
    //Ya tenemos la conexion de sunat
    ...
    public function getDespatch($data){
        ...
        ->setTipoDoc($data['tipoDoc']??'09')//Guia de Remision - Catalogo
    ...
    public function getEnvio($data){
        ...
        ->setFecTraslado(new DateTime($data['fecTraslado'])??null) // Zona hogrario
        ->setPesoTotal($data['pesoTotal']??null)
        ->setUndPesoTotal($data['undPesoTotal']??null)//Catalog. 03
    ...
    public function getVehiculo($vehiculos){
       ...
       return  (new Vehicle())
        ...
        $vehiculoSecundario = (new Vehicle())
                    ->setPlaca($data['placaSecundario']??null);
